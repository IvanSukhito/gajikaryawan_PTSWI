            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('general.upload_lembur')</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card {!! $printCard !!}">
                <div class="card-header">
                    <h3 class="card-title">@lang('general.upload_lembur')</h3>
                </div>
                <!-- /.card-header -->
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="example_upload_lembur">{{ __('general.example_upload_lembur') }} <span class="text-red">*</span></label><br />
                            <a href="?download_example_import=1"
                                class="btn btn-sm btn-primary" title="{{ __('general.download') }}" id="example_upload_lembur">
                    ...
                    <div class="form-group">
                        <label for="upload_lembur">{{ __('general.upload_lembur') }} <span class="text-red">*</span></label>
                        {{ Form::file('upload_lembur', ['class' => $errors->has('upload_lembur') ? 'form-control dropify is-invalid' : 'form-control dropify', 'id' => 'upload_lembur', 'required' => true, 'autocomplete' => 'off', 'accept' => '.xls, .xlsx']) }}
                    </div>
                </div>
                <!-- /.card-body -->
