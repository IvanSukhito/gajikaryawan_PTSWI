            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('general.salary')</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card {!! $printCard !!}">
                <div class="card-header">
                    <h3 class="card-title">@lang('general.salary')</h3>
                </div>
                <!-- /.card-header -->
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="example_salary">{{ __('general.example_salary') }} <span class="text-red">*</span></label><br />
                            <a href="?download_example_import=1"
                                class="btn btn-sm btn-primary" title="{{ __('general.download') }}" id="example_salary">
                    ...
                    <div class="form-group">
                        <label for="salary">{{ __('general.salary') }} <span class="text-red">*</span></label>
                        {{ Form::file('salary', ['class' => $errors->has('salary') ? 'form-control dropify is-invalid' : 'form-control dropify', 'id' => 'salary', 'required' => true, 'autocomplete' => 'off', 'accept' => '.xls, .xlsx']) }}
                    </div>
                </div>
                <!-- /.card-body -->
